package com.csdy.vampirismtinker.entity;
import com.csdy.vampirismtinker.entity.register.EntityRegister;
...
public class EntityFallingBlock extends Entity {
    ...
    public EntityFallingBlock(Level worldIn, BlockState blockState, float vy) {
        super(EntityRegister.FALLING_BLOCK.get(), worldIn);
    ...
    public EntityFallingBlock(Level level, double px, double py, double pz, BlockState blockState, int duration) {
        super(EntityRegister.FALLING_BLOCK.get(), level);
